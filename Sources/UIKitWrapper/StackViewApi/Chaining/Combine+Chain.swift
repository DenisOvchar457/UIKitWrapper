...
//	public subscript(_ value: Value) -> Base.Value where Base: ValueChainingProtocol {
//		self.apply()
//	}
//}
//extension Chain {
//	public subscript(_ value: Value) -> Value {
//		self.apply()
//	}
//}
//
...
//		let setter = (getter as? ReferenceWritableKeyPath<Base.Value, Value>)
//		value => {[weak result] in
//			guard let this = result else { return }
//			this[keyPath: setter!] = $0
////			_ = setter?(this, $0)
//		}
//	}
//}
